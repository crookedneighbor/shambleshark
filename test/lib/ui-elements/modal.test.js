...
describe('Modal', function () {
  ...
  it('has default loading label', function () {
    ...
    expect(modal.element.querySelector('.dialog-loader').getAttribute('aria-label')).toBe('Loading')
  })
  ...
  it('can provide a loading label', function () {
    ...
    expect(modal.element.querySelector('.dialog-loader').getAttribute('aria-label')).toBe('Custom Loading Message')
  })
})
